...
export default async function GalleryPage() {
  ...
  try {
    const [fetchedPhotos, fetchedCategories, fetchedContent] = await Promise.all([
    ...
    <div className="min-h-screen bg-[#fbfbf8] text-zinc-600 font-sans selection:bg-zinc-900 selection:text-white flex flex-col justify-between">
      <div className="pt-24 pb-12 px-4 md:pt-32 md:pb-24 md:px-6 lg:pt-48 lg:pb-32 3xl:pt-64 3xl:pb-48">
        <div className="max-w-7xl 2xl:max-w-[1700px] 3xl:max-w-[2400px] mx-auto">
          <header className="mb-10 md:mb-20 3xl:mb-32">
            ...
            <p className="text-[10px] lg:text-xs 3xl:text-base uppercase tracking-[0.4em] mt-4 md:mt-6 3xl:mt-12 opacity-40 font-medium">Cronologia de Instantes</p>
          </header>
